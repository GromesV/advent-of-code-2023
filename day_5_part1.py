...
def solution():
    """
    saves solution in a file named solution_day_5_part_2
    """

    with open('solution_day_5_part_2', 'w', encoding='utf-8') as output:
        output.write(5)
    exit()
    with open('day_5_input.txt', 'r', encoding='utf-8') as file:
        ...
        for rng in seed_list_total:
            for seed in rng:
                ...
                next_val = get_next(
                    next_val, maping['temperature-to-humidity'])
